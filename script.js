...
(function(){
  ...
  // CURSOR GLOW OVERLAY — desktop only. Skipped on mobile: there's no real
  // cursor there, so this used to sit frozen at screen-center and stretch
  // into a wide horizontal line on narrow/portrait screens.
  if(!isMobile){
